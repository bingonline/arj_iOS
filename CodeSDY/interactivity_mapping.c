...
/* Sensors storage */
sdy_gyro_event_t gyro_event;
sdy_accelerometer_event_t accelerometer_event;
sdy_magnetometer_event_t magnetometer_event;
...
void BHVR_Gyro(const sdy_gyro_event_t *evt){
    gyro_event.x = evt->x;
    gyro_event.y = evt->y;
    gyro_event.z = evt->z;
}

void BHVR_Accelerometer(const sdy_accelerometer_event_t *evt){
    accelerometer_event.x = evt->x;
    accelerometer_event.y = evt->y;
    accelerometer_event.z = evt->z;
}

void BHVR_Magnetometer(const sdy_magnetometer_event_t *evt){
    magnetometer_event.x = evt->x;
    magnetometer_event.y = evt->y;
    magnetometer_event.z = evt->z;
}
